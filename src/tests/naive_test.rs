...
// Naive way of using this based on the schemafy documentation 
include!("./generated/fhir-generated.rs");

///
/// Parse a real resource JSON package for Practitioner to validate parsing from JSON 
